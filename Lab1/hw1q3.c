...
int main(int argc, char **argv)
{
	...
	yo = -1;
	zo = 0; 
	b = -1; //will vary this manually to 1 and -1
	c = -1; //will vary this manually to -1
	f = 1; 
	...
	ofile = "hw1q3p_b-1c-1.ras";// Define the name of your output file, modify the name according to the requirements

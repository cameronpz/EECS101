...
int main(int argc, char **argv)
{
	...
	for (t = -1000; t < 10000.01; t += .01) 
	//I have adjusted the lower bound in order to get all of the light colored array elements from -4 to 4. 
	//There will be values for which this is out of bound for; however, the "in range" and "plot physical pt"
	//functions deal with this issue. The pts generated outside of the range will be kept black. 
	{
	...
	ofile = "hw1q1o.ras";// Define the name of your output file, modify the name according to the requirements
...
int plot_physical_point(int x, int y, unsigned char image[][COLS]) //given an x,y...given a pt, if it is in range, then set the value to 255
{
	if (in_range(x, y)) //return 0 => the pixel is kept at 0...dark;
